...
UpdateDataset <- function(dataset, numberOfIndexPages = 10, wget = FALSE, wait = 3, nameOfProject = NULL, nameOfWebsite = NULL) {
    ...
    if (gtools::invalid(params$param[params$args=="divClassDatesXpath"]) == TRUE & gtools::invalid(params$param[params$args=="spanClassDatesXpath"]) == TRUE & gtools::invalid(params$param[params$args=="customXpathDates"]) == TRUE) {
        dates <- ExtractDates(articlesHtml = articlesHtmlNew, dateFormat = params$param[params$args=="dateFormat"], language = dataset$language[1], customString = params$param[params$args=="customStringExtractDates"], minDate = params$param[params$args=="minDate"], maxDate = params$param[params$args=="maxDate"], removeEverythingBefore = params$param[params$args=="removeEverythingBeforeExtractDates"])
    } else {
        dates <- ExtractDatesXpath(articlesHtml = articlesHtmlNew, dateFormat = params$param[params$args=="dateFormat"], divClass = params$param[params$args=="divClassDatesXpath"], spanClass = params$param[params$args=="spanClassDatesXpath"], customXpath = params$param[params$args=="customXpathDates"], language = dataset$language[1], customString = params$param[params$args=="customStringExtractDates"], minDate = params$param[params$args=="minDate"], maxDate = params$param[params$args=="maxDate"], keepAllString = params$param[params$args=="keepAllString"])
    }
