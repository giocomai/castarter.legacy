...
UpdateDataset <- function(dataset, articlesLinks = NULL, numberOfIndexPages = 10, wget = FALSE, wait = 3, project = NULL, website = NULL) {
    ...
    articlesTxt <- ExtractTxt(articlesHtml = articlesHtmlNew, metadata = metadata, export = FALSE, maxTitleCharacters = params$param[params$args=="maxTitleCharacters"], removeString = unlist(stringr::str_split(string = params$param[params$args=="removeString_ExtractTxt"], pattern = "§§§")), divClass = params$param[params$args=="divClass_ExtractTxt"], divId = params$param[params$args=="divId_ExtractTxt"], removeEverythingAfter = params$param[params$args=="removeEverythingAfter_ExtractTxt"], removeEverythingBefore = params$param[params$args=="removeEverythingBefore_ExtractTxt"], removePunctuationInFilename = params$param[params$args=="removePunctuationInFilename"], keepEverything = params$param[params$args=="keepEverything_ExtractTxt"], removeTitleFromTxt = params$param[params$args=="removeTitleFromTxt"], exportParameters = FALSE)
