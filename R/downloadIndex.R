CreateIndexPagesLinks <- function(linkFirstChunkIndex, linkSecondChunkIndex = "", firstIndexPage = 1, lastIndexPage = 10, increaseBy = 1, dateStyle = "", firstYear = "", lastYear = "", leadingZero = TRUE, startDate = "", endDate = "", sortIndexPagesLinks = TRUE, dateSeparator = "/", export = FALSE, reversedOrder = FALSE) {
...
DownloadIndexPagesForm <- function(nameOfProject, nameOfWebsite, linkFirstChunkIndex, firstYear = "", lastYear = "", dateSeparator = "/", dateBy = "months", start = 1) {
