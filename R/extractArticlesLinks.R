ExtractArticlesLinks <- function(domain, partOfDirectLink, indexPagesHtml, containerType = "", containerClass = "", divClass = "", partOfDirectLinkToExclude = "", sort = TRUE, export = FALSE) {
