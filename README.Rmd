...
```{r CreateFolders, eval=FALSE, include=TRUE}
CreateFolders()
```
...
``` {r CreateLinks, eval=FALSE, include=TRUE}
indexLinks <- CreateLinks(
    ...
    increaseBy = 10)
```
``` {r CreateLinksEvalutate, eval=TRUE, include=FALSE}
indexLinks <- CreateLinks(
    linkFirstChunk = "http://www.europarl.europa.eu/news/en/news-room/press-release?start=",
    startPage = 0,
    endPage = 5560,
...
load(file = "2017-01-11 - EuropeanUnion - EuropeanParliament - dataset.RData")
```
